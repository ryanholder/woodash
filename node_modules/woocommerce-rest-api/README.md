...
This is a client for the [WordPress REST API](http://wp-api.org/). It is **under active development**, and should be considered beta software. More features will be coming over the course of the summer; meanwhile, **[issues](https://github.com/kadamwhite/woocommerce-rest-api/issues)** are welcome if you find something that doesn't work!

[![Build Status](https://api.travis-ci.org/kadamwhite/woocommerce-rest-api.png?branch=master)](https://travis-ci.org/kadamwhite/woocommerce-rest-api)
...
In addition to the above getting-started guide, we have automatically-generated [API documentation](http://kadamwhite.github.io/woocommerce-rest-api). More user-oriented documentation, including a more in-depth overview of available endpoint and filter methods, will be added to this README in the near future.


## Issues

If you identify any errors in this module, or have an idea for an improvement, please [open an issue](https://github.com/kadamwhite/woocommerce-rest-api/issues). We're excited to see what the community thinks of this project, and we would love your input!
