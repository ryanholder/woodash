...
```
See the [existing test files](https://github.com/kadamwhite/woocommerce-rest-api/tree/master/tests) for more examples.

#### Mocking Dependencies

When testing code that uses 3rd-party modules, mocks may be injected for those dependencies by using the [sandboxed-module](https://www.npmjs.org/package/sandboxed-module) package. See the [WPRequest tests](https://github.com/kadamwhite/woocommerce-rest-api/blob/master/tests/lib/WPRequest.js) for example usage.
...
* **bug/bug-name-[Github Issue #]**: Bug fixes: these should always have a corresponding [GH issue](https://github.com/kadamwhite/woocommerce-rest-api/issues).
