...
.controller('drawerCtrl', ['$element', '$attrs', '$ionicGesture', '$document', '$ionicBody', function($element, $attr, $ionicGesture, $document, $ionicBody) {
  var el = $element[0];
  var dragging = false;
...
.directive('drawer', ['$rootScope', '$ionicGesture', '$ionicBackdrop', '$ionicBody', function($rootScope, $ionicGesture, $ionicBackdrop, $ionicBody) {
  return {
    restrict: 'E',
      //replace: false,
      //transclude: 'element',
