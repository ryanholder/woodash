...
.directive('drawer', ['$rootScope', '$document', '$animate', '$ionicGesture', '$ionicBackdrop', '$ionicBody', function($rootScope, $document, $animate, $ionicGesture, $ionicBackdrop, $ionicBody) {
  return {
    restrict: 'E',
      replace: true,
      transclude: true,
    ...
    controller: 'drawerCtrl',
      ...
      '<div class="drawer right" ng-transclude></div>' +
      '</div>' +
      '</div>',
